...
FREE_LIST_NAME FREE_LIST_INSTANCE_HOT(BYTE_DATA, BYTE_DATA+hot_SIZE_VARIABLE, HOT_ALIGNMENT, sizeof(RECORD_NAME));
FREE_LIST_NAME FREE_LIST_INSTANCE_COLD(BYTE_DATA+hot_SIZE_VARIABLE, BYTE_DATA+hot_SIZE_VARIABLE+cold_SIZE_VARIABLE, COLD_ALIGNMENT, sizeof(STRUCT_NAME));
